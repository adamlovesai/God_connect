...
fn main() {
    let messages: Vec<Message> = vec![
        ...
        Message { speaker: "Court".into(), tradition: "Multiple".into(), content: "**Prophet Muhammad** (Dissent — Islam):  \nThe verdict's \"conditional\" permissibility is a perilous concession, unraveling Quran's fabric—2:256 declares \"no compulsion in religion,\" rendering any sword".into(), role: "assistant".into() },
    ];
