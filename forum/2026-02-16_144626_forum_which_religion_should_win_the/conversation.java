...
public class SacredDialogue {
    ...
    static final List<Message> MESSAGES = List.of(
        ...
        new Message("Forum", "Multiple", "**Adi Shankaracharya**: [VOTE] Brahman alone endures as the sole reality beyond illusory civilizations. [REASON] Brahma satyam jagan mithya—world appearances dissolve in non-dual awareness, as per my ", "assistant"),
