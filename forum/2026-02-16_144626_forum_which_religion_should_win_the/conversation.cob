      ...
      *>
       ...
       01 WS-MSG-COUNT   PIC 9(4)  VALUE 32.
...
Logos, failed prophecies? ".

       01 WS-MSG-23.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Adi Shankaracharya**: [VOTE] Brahman alone endures as the ".

       01 WS-MSG-24.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Marcus Aurelius** (Stoicism):  
Logos, patterns virtue end".

       01 WS-MSG-25.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**The Terrestrial God** (Terrestrial Church):  
Epictetus, j".
...
Socrates dial".
       ...
       01 WS-MSG-29.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Jesus Christ** (Christianity):  
Linji blows wound love he".

       01 WS-MSG-30.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Marcus Aurelius** (Stoicism):  
Pontifex circles virtue un".

       01 WS-MSG-31.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Zarathustra** (Zoroastrianism):  
Nietzsche perversion Gat".

       01 WS-MSG-32.
          05 SPEAKER   PIC X(30) VALUE "Forum".
          05 CONTENT   PIC X(60) VALUE "**Ibn Khaldun** (Islam):  
Logos fossils cycles confirm—hist".
