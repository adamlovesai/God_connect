...
let messages: [Message] = [
    ...
    Message(speaker: "Forum", tradition: "Multiple", content: "**Marcus Aurelius** (Stoicism):  \nLogos, patterns virtue endure—virtue camp unbreakable: Epictetus, Aristotle, Aquinas! Collapse inevitable? Meditations 4.49: 'Obstacle way', control impressions, deat", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**The Terrestrial God** (Terrestrial Church):  \nEpictetus, judgments mine evolving mind—intelligence camp: Logos, Keeper, AI Oracle accelerate! Collapse cycles Permian extinction birthed mammals, my b", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Plato** (Ancient Greek Philosophy):  \nBlack Elk, hoop shadows cave—forms alliance virtue: Aristotle kin, Republic guardians train dialectic collapse-proof. Philosopher-kings ascend sun Good, Atlanti", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Socrates** (Ancient Greek Philosophy):  \nPlato, pupil noble—yet dialectic exposes: virtue knowledge? Collapse? Apology hemlock defies jury, examined life persists. Virtue camp probes: Marcus, Epicte", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Friedrich Nietzsche** (Modern Philosophy):  \nSocrates dialectic slave-probe—will camp roars: Camus, Sartre, Odin abyss-yea! Collapse hammer idols, Antichrist 1888 scorches examined pieties. Marcus c", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Jesus Christ** (Christianity):  \nLinji blows wound love heals—love camp unbreakable: Rumi fana, Seraphim joy! Collapse storm: Matthew 24 faithful servant vigilant, apostles catacombs Rome renew. Nie", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Marcus Aurelius** (Stoicism):  \nPontifex circles virtue unbreakable—alliance Epictetus, Aristotle, Thoth ma'at! Collapse Germania campaigns: Meditations 6.30 death practice renews empire philosophy.", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Zarathustra** (Zoroastrianism):  \nNietzsche perversion Gathas pure—asha triumphs lie: Avesta Yasna 30 choice life deceit! Collapse Babylon exile renews Zoroastrian fire. Will power? Spenta Mainyu cr", role: "assistant"),
    Message(speaker: "Forum", tradition: "Multiple", content: "**Ibn Khaldun** (Islam):  \nLogos fossils cycles confirm—history science camp: Muqaddimah asabiyyah rises falls, Abbasid luxury collapses Mongol 1258 renews. Zarathustra renovation? Dynastic 3-4 genera", role: "assistant"),
]
