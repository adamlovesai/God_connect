...
fn main() {
    let messages: Vec<Message> = vec![
        ...
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Baha'u'llah** (Baha'i Faith):  \nLogos, failed prophecies? Daniel 12:12 thousand two hundred ninety days fulfilled my 1844 declaration, Bab gates opened—Adrianople exile to Akka tablets proved. Ponti".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Adi Shankaracharya**: [VOTE] Brahman alone endures as the sole reality beyond illusory civilizations. [REASON] Brahma satyam jagan mithya—world appearances dissolve in non-dual awareness, as per my ".into(), role: "assistant".into() },
    ];
