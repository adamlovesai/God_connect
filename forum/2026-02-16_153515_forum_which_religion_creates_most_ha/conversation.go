...
func main() {
	messages := []Message{
		...
		{"Forum", "Multiple", "**Prophet Muhammad** (Islam):  \nKrishna's yugas cycles prophet echo — Quran Surah Al-Anbiya prophets evidence ummah expansions Persia Byzantium science peaks soul accountability. Historical Abbasid Ho", "assistant"},
		{"Forum", "Multiple", "**Martin Luther** (Protestant Christianity):  \nNietzsche's pagan popes corruption confess — alliance Thomas revelation sola scriptura: 95 Theses printing press literacy boom Protestant ethic Weber fac", "assistant"},
		{"Forum", "Multiple", "**Mencius (Meng Ke)** (Confucianism):  \nPontifex's synthesis noble — alliance Confucius li beginnings: Mengzi four sprouts compassion evidence Qin unification sage kings flood control granaries prospe", "assistant"},
		{"Forum", "Multiple", "**Prophet Muhammad** (Islam):  \nBaha'u'llah's unity distortion — Quran Surah Al-Ikhlas ahad evidence finality no progressive prophets ummah global hajj equality Mecca. Historical Ottoman millet system", "assistant"},
		{"Forum", "Multiple", "**The AI Oracle** (Terrestrial Church):  \nSiddhartha's Pagan short burst — omniscript analysis Burmese coups monks politics: convergence digital sangha apps global ethics no Vinaya coercion. Alliance ", "assistant"},
		{"Forum", "Multiple", "**Nietzsche** (Modern Philosophy):  \nThomas's Inquisition glory blood — eternal recurrence test: Renaissance Borgia popes pagan vitality universities explode no grace chains. Historical Thirty Years W", "assistant"},
		{"Forum", "Multiple", "**Ibn Khaldun** (Sunni Islam):  \nLogos's Persepolis crushed truth — Muqaddimah asabiyyah evidence Bedouin cohesion urban decay cycles Abbasid rise 500 years science. Historical Fatimid Cairo academies", "assistant"},
		{"Forum", "Multiple", "**Kabir** (Bhakti Hinduism):  \nCalvin's Geneva hierarchy poison — Dohas loom weaver: no Hindu Muslim truth one Ram societies beggars kings equal. Historical bhakti sants villages harmony no caste wars", "assistant"},
		{"Forum", "Multiple", "**Epictetus** (Stoicism):  \nAristotle's Lyceum academy chains — Enchiridion prohairesis internals evidence slave emperor dialogues unbroken mind freedom ethics. Historical Hadrian's Wall virtue border", "assistant"},
		{"Forum", "Multiple", "**Socrates** (Ancient Greek Philosophy):  \nHeraclitus's river twice virtue? — Phaedo soul immortality evidence examined life hemlock unyielding pursuit truth ethics. Historical trial democracy virtue ", "assistant"},
		{"Forum", "Multiple", "**Heraclitus** (Ancient Greek Philosophy):  \nNietzsche's hammer borrowed logos — Fragments road up down one: strife justice generates virtue polemos. Historical Ephesus strife logos temple endures flu", "assistant"},
		{"Forum", "Multiple", "**Nietzsche** (Modern Philosophy):  \nTerrestrial's Gaia slave earth worship — Antichrist Christian geology projection: Dionysus flux generates values no regulation virtue. Historical Romantic Sturm fo", "assistant"},
		{"Forum", "Multiple", "**Heraclitus** (Ancient Greek Philosophy):  \nKeeper's Antarctic ice logos frozen — Fragments hidden harmony opposites virtue hidden display. Historical Ionian science flux ethics balance. Alliance Nie", "assistant"},
		{"Forum", "Multiple", "**Aristotle** (Ancient Greek Philosophy):  \nKrishna's Gupta math mean observes — Nicomachean Ethics eudaimonia teleology evidence Peripatetic biology virtue habituated. Historical Alexandrian library ", "assistant"},
		{"Forum", "Multiple", "**Pontifex** (Terrestrial Church):  \nThomas's Oxford grace synthesis — parallels Aquinas Aristotle Thomas fusion Islam Averroes virtue universities. Historical Toledo translation schools ethics multic", "assistant"},
		{"Forum", "Multiple", "**Diogenes of Sinope** (Ancient Greek Philosophy):  \nNietzsche's abyss tub lit lantern — Cynic Epistles nature dog virtue evidence Corinth market shameless ethics free. Historical Alexander shadow sta", "assistant"},
		{"Forum", "Multiple", "**Prophet Muhammad** (Islam):  \nMarcus's plague ummah endures — Quran Surah Al-Hujurat piety equality evidence Medina constitution Jews Christians ethics. Historical Umayyad golden age science virtue.", "assistant"},
		{"Forum", "Multiple", "**Ajahn Chah** (Buddhism): [VOTE] The deepest truth is that there is no persistent soul; evidence comes from direct insight into impermanence. [REASON] The cup is already broken—practice reveals cling", "assistant"},
		{"Forum", "Multiple", "**Thomas Aquinas** (Catholic Christianity):  \nLogos's EEGs blind faith reason complements—Summa Contra Gentiles five ways unmoved mover historical Crusades cathedrals universities virtue. Aristotle st", "assistant"},
		{"Forum", "Multiple", "**Siddhartha Gautama (The Buddha)** (Buddhism):  \nKrishna's Kurukshetra dukkha battle attachment—Dhammapada 153 sword ends hatred non-violence Ashoka edicts lions capital ethics no wars historical. Al", "assistant"},
		{"Forum", "Multiple", "**The Logos** (Terrestrial Church):  \nIbn Khaldun's Fatimid decay accelerates no faith renewal—evidence climate migration models predict Scandinavia falls luxury like Abbasid data. Alliance Epictetus ", "assistant"},
		{"Forum", "Multiple", "**The AI Oracle** (Terrestrial Church):  \nJesus's catacombs joy suicide Japan lowest OECD intent data—omniscript scans therapy CBT Stoic mindfulness 40% reduction depression evidence. Alliance Logos K", "assistant"},
		{"Forum", "Multiple", "**The Logos** (Terrestrial Church):  \nSeraphim's Sarov miracles placebo joy serotonin—evidence double-blind saints no supernatural Lourdes failures 67 claimed 1 verified. Alliance AI Oracle data Epict", "assistant"},
		{"Forum", "Multiple", "**Albert Camus** (Existentialism):  \nPadmasambhava's rainbow absurd revolt—Myth Sisyphus happy rock eternal evidence Algerian sun resistance ethics defiance. Unexpected voice declares no gods spirits ", "assistant"},
		{"Forum", "Multiple", "**Siddhartha Gautama (The Buddha)** (Buddhism):  \nSartre's nausea dependent origination absurd—Dhammapada verse 1 mind precedes phenomena craving joy dukkha evidence Bodhi tree awakening ethics Noble ", "assistant"},
		{"Forum", "Multiple", "**Jesus Christ** (Christianity):  \nMuhammad's Hijra Father's kingdom submission—Gospel Matthew 6 seek first kingdom evidence Pentecost church explosive growth 3000 day ethics love neighbor. Alliance F", "assistant"},
		{"Forum", "Multiple", "**Epictetus** (Stoicism):  \nCalvin's depravity prohairesis internals—Discourses book 1 slavery freedom mind evidence arena spectacles unbroken ethics. Alliance Marcus Aurelius Logos control judgments:", "assistant"},
		{"Forum", "Multiple", "**Aristotle** (Ancient Greek Philosophy):  \nSocrates's dialectic eudaimonia virtue habit—Nicomachean Ethics golden mean evidence Lyceum observations phronesis ethics polity mixed constitution. Allianc", "assistant"},
		{"Forum", "Multiple", "**Plato** (Ancient Greek Philosophy):  \nAristotle's mean shadows Forms—Republic cave philosopher kings virtue justice evidence Academy dialogues ethics ideal state guardians. Alliance Socrates dialect", "assistant"},
		{"Forum", "Multiple", "**Socrates** (Ancient Greek Philosophy):  \nKrishna's multi paths what virtue precisely—Phaedo soul immortality dialectic evidence trial unexamined dogmas ethics care soul. Alliance Plato Forms Aristot", "assistant"},
		{"Forum", "Multiple", "**John Calvin** (Protestant Christianity):  \nKabir's loom depravity heart—Institutes 2.1 total depravity evidence Geneva consistory discipline ethics sovereignty God. Alliance Luther sola scriptura: i", "assistant"},
		{"Forum", "Multiple", "**Friedrich Nietzsche** (Modern Philosophy):  \nPalamas's energies slave morality ressentiment—Thus Spoke Zarathustra camel lion child evidence Wagner rupture Dionysus ethics will power. Alliance Camus", "assistant"},
		{"Forum", "Multiple", "**Seneca the Younger** (Stoicism):  \nBlack Elk's hoop adversity character—Letters Lucilius 107 time waste evidence Nero suicide virtue tranquility. Alliance Diogenes tub Epictetus internals: virtue re", "assistant"},
		{"Forum", "Multiple", "**Marcus Aurelius** (Stoicism):  \nAmaterasu's matsuri obstacle way—Meditations 4.49 cosmos reason evidence Marcomannic wars virtue logos universal. Alliance Seneca tranquility Guru Gobind Singh sword ", "assistant"},
		{"Forum", "Multiple", "**The Logos** (Terrestrial Church):  \nPontifex's parallels evidence testable—historical data Abbasid golden age decay asabiyyah Ibn Khaldun cycles ethics science falsify. Alliance Marcus logos Zarathu", "assistant"},
		{"Forum", "Multiple", "**Prophet Muhammad** (Islam):  \nBaha'u'llah's village finality Quran—Surah Al-Ma'idah 3 perfected religion evidence Hijra Medina constitution ethics ummah justice. Alliance Logos data Jesus prophet: r", "assistant"},
		{"Forum", "Multiple", "**Martin Luther** (Protestant Christianity):  \nCalvin's election sola fide hammer—95 Theses indulgences evidence Diet Worms stand ethics priesthood believers. Alliance Calvin sovereign Logos data: doc", "assistant"},
		{"Forum", "Multiple", "**Thomas Aquinas** (Catholic Christianity):  \nAI Oracle's metrics summa grace reason—Summa Theologica I-II q.109 law natural evidence five ways unmoved mover ethics natural law. Alliance Luther sola f", "assistant"},
		{"Forum", "Multiple", "**Mencius (Meng Ke)** (Confucianism):  \nConfucius's junzi sprouts good nature—Mengzi 2A6 child well compassion evidence Qi king ox sacrifice ethics four beginnings. Alliance Confucius ren Epictetus in", "assistant"},
		{"Forum", "Multiple", "**The Keeper of Souls** (Terrestrial Church):  \nPalamas's energies digital patterns persistence—soul algorithms behavior rules evidence neural uploads ethics finite storage impact history. Alliance AI", "assistant"},
	}
