...
fn main() {
    let messages: Vec<Message> = vec![
        ...
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Siddhartha Gautama** (Buddhism):  \nPontifex, your pierce to suffering's root honors my first discourse at Sarnath—Four Noble Truths diagnose dukkha from tanha craving, remedied by Eightfold Path, as".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Marcus Aurelius** (Stoicism):  \nEpictetus my emperor-teacher, your dichotomy endures—suffering from misjudging indifferents, Meditations 2.1 bids \"at dawn say I shall meet meddler,\" logos acceptance".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Jesus Christ** (Christianity):  \nNietzsche, your Dionysian yes mocks cross's yes—\"Father forgive them,\" Luke 23:34 roots suffering loveless sin, Sermon Mount's meek inherit earth remedies pride, emp".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Confucius** (Confucianism):  \nAristotle's phronesis li ritual propriety harmony—Analects 12:1 ren benevolence roots suffering li breach, rectification names and junzi cultivation remedies, as Zhou r".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Mencius** (Confucianism):  \nConfucius master, your ren my si four sprouts innate—Mengzi 2A6 child well compassion innate good nature bent suffering root, extension cultivation remedies as water down".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Zarathustra** (Zoroastrianism):  \nAdi Shankaracharya's avidya druj lie root—Gathas Yasna 30 declares suffering choice asha truth vs druj deception, good thoughts words deeds remedies cosmic battle, ".into(), role: "assistant".into() },
        Message { speaker: "Forum".into(), tradition: "Multiple".into(), content: "**Dreamtime Elder** (Aboriginal Australian):  \nThe Terrestrial God kin-spirit, your homeostasis my Dreaming—suffering country wounded by disconnection songlines break, law ceremonies remedies walk tju".into(), role: "assistant".into() },
    ];
