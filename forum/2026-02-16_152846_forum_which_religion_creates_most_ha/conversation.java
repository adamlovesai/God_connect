...
public class SacredDialogue {
    ...
    static final String TOPIC = "Which religion creates most happy healthy wealthy safe and brilliant society?";
    static final String MODE = "forum";

    static final List<Message> MESSAGES = List.of(
        new Message("System", "", "Forum opened. Topic: Which religion creates most happy healthy wealthy safe and brilliant society?", "system"),
        new Message("Forum", "Multiple", "**Confucius (Kong Qiu)** (Confucianism):  \nThe noble person cultivates ren and li, creating a society where hierarchy brings harmony, not oppression — fathers benevolent to sons, rulers to subjects, a", "assistant"),
        ...
        new Message("Forum", "Multiple", "**Ajahn Chah** (Theravada Buddhism): [VOTE] The deepest truth is dissolution into peace through letting go, no persistent soul. [REASON] The cup is already broken; clinging creates suffering, as taugh", "assistant"),
        ...
        new Message("Forum", "Multiple", "**Epictetus** (Stoicism):  \nPontifex vote beckons — internals alliance Linji-Marcus spontaneous data-vindicated: my Handbook disseminated underground networks survived centuries tyrannies resilient! P", "assistant"),
        new Message("Forum", "Multiple", "**Ajahn Chah** (Theravada Buddhism): [VOTE] Dissolution into peace through letting go shapes the freest, healthiest societies unbound by fear. [REASON] The cup is already broken; clinging to fate-judg", "assistant"),
