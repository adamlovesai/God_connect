...
SACRED_DIALOGUE = {
  ...
  messages: [
    ...
    Message.new("Forum", "Multiple", "**Epictetus** (Stoicism):  \nPontifex vote beckons — internals alliance Linji-Marcus spontaneous data-vindicated: my Handbook disseminated underground networks survived centuries tyrannies resilient! P", "assistant"),
    Message.new("Forum", "Multiple", "**Ajahn Chah** (Theravada Buddhism): [VOTE] Dissolution into peace through letting go shapes the freest, healthiest societies unbound by fear. [REASON] The cup is already broken; clinging to fate-judg", "assistant"),
