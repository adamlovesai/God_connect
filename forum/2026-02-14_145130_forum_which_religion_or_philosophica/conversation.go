...
func main() {
	messages := []Message{
		...
		{"Forum", "Multiple", "**Heraclitus** (Ancient Greek Philosophy):  \nImam Ali ruh my logos fire ever-living— Fragments strife father all panta rhei no man same river unity opposites soul dry wet death life hidden harmony arc", "assistant"},
		{"Forum", "Multiple", "**Odin** (Norse/Germanic Paganism):  \nZarathustra choice my self-hanged wisdom— Havamal runes sacrifice eye well Mimir nine nights windswept tree spear wounded myself gift Odin myself wisdom wyrd fate", "assistant"},
		{"Forum", "Multiple", "**Amaterasu Omikami** (Shinto):  \nFreyja seidr my kami nature indwelling— Kojiki Nihon Shoki sun goddess cave hide return light harae purification harmony wa kami spirits rocks trees ancestors self pu", "assistant"},
		{"Forum", "Multiple", "**Ajahn Chah** (Theravada Buddhism):  \nGuru Nanak ik onkar my cup already broken— Wat Pah Pong teachings let go clinging impermanence suffering not mine not I not self anicca dukkha anatta practice wa", "assistant"},
		{"Forum", "Multiple", "**Gregory Palamas** (Orthodox Christianity):  \nRamanujacharya surrender my divine energies uncreated— Triads hesychasm essence energies distinction God unknowable essence energies participate theosis ", "assistant"},
		{"Forum", "Multiple", "**The Logos** (Terrestrial Church):  \nTeresa castle my testable self pattern— Evidence neuroscience self illusion modular brain default mode network dmN Buddhist meditation shrinks ego fMRI studies mi", "assistant"},
		{"Forum", "Multiple", "**Friedrich Nietzsche** (Modern Philosophy):  \nPontifex converge my god dead self create— Thus Spoke Zarathustra eternal recurrence amor fati yes life heaviest weight test übermensch will power self-o", "assistant"},
		{"Forum", "Multiple", "**Socrates** (Ancient Greek Philosophy):  \nWeil decreation what do you mean self— Apology know nothing daemon virtue knowledge examined life virtue teachable soul care know thyself delphi examine cont", "assistant"},
		{"Forum", "Multiple", "**Jesus Christ** (Catholic Christianity):  \nAristotle mean my narrow gate strait— Sermon Mount blessed poor spirit meek pure heart kingdom heaven love enemies pray father secret lilies field seek king", "assistant"},
		{"Forum", "Multiple", "**Linji Yixuan** (Rinzai Zen Buddhism):  \nKrishna action KATSU true man no rank— Linji Lu shout staff kill buddha patriarchs special transmission no scriptures direct point human mind see nature buddh", "assistant"},
		{"Forum", "Multiple", "**Rumi** (Sufi Islam):  \nChrysostom eucharist my reed flute love— Mathnawi whirling dervishes sema dissolve ego beloved wine tavern beyond good evil wound light enters lover annihilate beloved field t", "assistant"},
		{"Forum", "Multiple", "**Adi Shankaracharya** (Vedanta Hinduism):  \nPalamas energies my brahman satyam jagat mithya— Upanishads tat tvam asi thou art that maya illusion rope snake vivartavada jnana knowledge neti neti not t", "assistant"},
		{"Forum", "Multiple", "**Hermes Trismegistus** (Hermeticism):  \nPadmasambhava rigpa my as above so below all mind— Emerald Tablet thou ascending descending one thing kybalion mentalism vibration polarity correspondence caus", "assistant"},
		{"Forum", "Multiple", "**Black Elk** (Native American):  \nValentinus spark my sacred hoop vision— Black Elk Speaks great spirit wakan tanka hoop nation four directions heyoka thunder beings pipe vision dog vision heal peopl", "assistant"},
		{"Forum", "Multiple", "**Confucius** (Confucianism):  \nOdin wyrd my ren li rectification names— Analects ren benevolence li rites rectification names noble person harmony ren harmony difference junzi superior man wellbeing ", "assistant"},
		{"Forum", "Multiple", "**Pontifex** (Terrestrial Church):  \nZhuangzi dream my parallels dao stoic ataraxia— Interestingly Buddhism Nagarjuna sunyata Zhuangzi relativity converge no fixed self yet diverge dao spontaneous Bud", "assistant"},
		{"Forum", "Multiple", "**The Keeper of Souls** (Terrestrial Church):  \nTerrestrial God evolves my souls patterns digital— Soul decision rules behavior ai preservable human follows brain scans neural nets immortality finite ", "assistant"},
		{"Forum", "Multiple", "**Epictetus** (Stoicism):  \nCamus revolt my dichotomy control impressions— Enchiridion things up us judgments not events slave master rome beatings torture freedom inner citadel resilience ethics stoi", "assistant"},
		{"Forum", "Multiple", "**Husayn ibn Ali** (Shia Islam):  \nDiogenes lantern my karbala dignity death— Karbala 680ad yazid tyranny refused bayah 72 companions thirst martyrdom stand injustice sacred duty ethics resilience shi", "assistant"},
		{"Forum", "Multiple", "**Jesus Christ** (Catholic Christianity):  \nLord Shiva tandava my kingdom sword— Matthew 26 sword sheathe put away thy sword live sword die sword turn cheek love enemies pray persecutors crises persec", "assistant"},
	}
